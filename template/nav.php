<nav class="navbar sticky-top ziad-navbar navbar-expand-lg bg-light navbar-light">
    <div class="container">
        ...
        <div class="collapse justify-right navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav" id="navTop">
                <li class="nav-item"><a href="https://atique.xyz/sd" class="nav-link"><span>Home</span></a></li>
                <li class="nav-item"><a href="https://atique.xyz/sd/#about-me" class="nav-link"><span>About me</span></a></li>
                <li class="nav-item"><a href="resume.php" id="resume" class="nav-link"><span>Resume</span></a></li>
                <li class="nav-item"><a href="https://atique.xyz/sd/#portfolio" class="nav-link"><span>Portfolio</span></a></li>
